...
class SubjectAdmin(admin.ModelAdmin):
    list_display = ('subject_code', 'subject_name', 'course_name', 'year_level', 'subject_unit', 'section', 'section_time', 'section_day', 'section_room')
    list_filter = ('course_name', 'year_level', 'section')
...
class StudentAdmin(admin.ModelAdmin):
    list_display = ('first_name', 'last_name', 'middle_name', 'age', 'section_name', 'year_level', 'semester_enrolled', 'subjects_display', 'student_id', 'enrollment_date', 'status')
    search_fields = ('first_name', 'middle_name', 'last_name', 'age', 'year_level', 'course_name', 'semester', 'enrollment_date')
    list_filter = ('year_level', 'course_name', 'section_name')
